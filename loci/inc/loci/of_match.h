...
typedef struct of_match_fields_s {
    ...
    uint8_t              pbb_uca;
    uint8_t              circuit_och_sigtype_basic;
    of_circuit_sig_id_t  circuit_och_sigid_basic;
    uint32_t             och_sigatt_basic;
    of_ipv4_t            tunnel_ipv4_src;
    of_ipv4_t            tunnel_ipv4_dst;
    uint16_t             tun_gbp_id;
    uint8_t              tun_gbp_flags;
    uint16_t             tun_flags;
    uint8_t              tun_gpe_np;
    uint8_t              tun_gpe_flags;
    uint32_t             nsp;
    uint8_t              nsi;
    uint32_t             nsh_c1;
    uint32_t             nsh_c2;
    ...
    uint8_t              nsh_mdtype;
    uint8_t              nsh_np;
    of_mac_addr_t        encap_eth_src;
    of_mac_addr_t        encap_eth_dst;
    ...
    uint8_t              circuit_och_sigtype;
    of_circuit_sig_id_t  circuit_och_sigid;
    uint32_t             och_sigatt;
    uint8_t              exp_odu_sigtype;
    of_odu_sig_id_t      exp_odu_sigid;
    uint8_t              exp_och_sigtype;
    uint8_t              ofdpa_qos_index;
    of_och_sig_id_t      exp_och_sigid;
