...
void
of_bsn_set_pktin_suppression_request_init(of_object_t *obj,
...
void
of_bsn_shell_command_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_bsn_shell_output_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_bsn_shell_status_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_experimenter_stats_reply_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        switch (value) {
        case 0x421337:
            of_sdwn_reply_wire_object_id_get(obj, id);
            break;
        case 0x5c16c7:
            of_bsn_stats_reply_wire_object_id_get(obj, id);
            break;
        case 0x748771:
            *id = OF_CIRCUIT_PORTS_REPLY;
            break;
        case 0x80f958:
            of_calient_stats_reply_wire_object_id_get(obj, id);
            break;
        case 0xff000007:
            of_exp_optical_ext_reply_wire_object_id_get(obj, id);
            break;
        case 0xff000088:
            of_oplink_stats_reply_wire_object_id_get(obj, id);
            break;
        default:
            *id = OF_EXPERIMENTER_STATS_REPLY;
            break;
...
void
of_experimenter_stats_reply_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_experimenter_stats_request_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        switch (value) {
        case 0x421337:
            of_sdwn_request_wire_object_id_get(obj, id);
            break;
        case 0x5c16c7:
            of_bsn_stats_request_wire_object_id_get(obj, id);
            break;
        case 0x748771:
            *id = OF_CIRCUIT_PORTS_REQUEST;
            break;
        case 0x80f958:
            of_calient_stats_request_wire_object_id_get(obj, id);
            break;
        case 0xff000007:
            of_exp_optical_ext_request_wire_object_id_get(obj, id);
            break;
        case 0xff000088:
            of_oplink_stats_request_wire_object_id_get(obj, id);
            break;
        default:
            *id = OF_EXPERIMENTER_STATS_REQUEST;
            break;
