...
void
of_oxm_bsn_ip_fragmentation_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x33401); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_bsn_ip_fragmentation of_oxm_bsn_ip_fragmentation
 */

/**
 * Create a new of_oxm_bsn_ip_fragmentation object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_oxm_bsn_ip_fragmentation_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_IP_FRAGMENTATION];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_bsn_ip_fragmentation_init(obj, version, bytes, 0);
    of_oxm_bsn_ip_fragmentation_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_bsn_ip_fragmentation.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_bsn_ip_fragmentation_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_BSN_IP_FRAGMENTATION] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_BSN_IP_FRAGMENTATION;
...
/**
 * Get value from an object of type of_oxm_bsn_ip_fragmentation.
 * @param obj Pointer to an object of type of_oxm_bsn_ip_fragmentation.
 * @param value Pointer to the child object of type
    ...
    uint8_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_BSN_IP_FRAGMENTATION);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_bsn_ip_fragmentation.
 * @param obj Pointer to an object of type of_oxm_bsn_ip_fragmentation.
 * @param value The value to write into the object
 */
void
of_oxm_bsn_ip_fragmentation_value_set(
    of_oxm_bsn_ip_fragmentation_t *obj,
    uint8_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_oxm_bsn_ip_fragmentation_masked_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x33502); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_bsn_ip_fragmentation_masked of_oxm_bsn_ip_fragmentation_masked
 */

/**
 * Create a new of_oxm_bsn_ip_fragmentation_masked object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_oxm_bsn_ip_fragmentation_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_IP_FRAGMENTATION_MASKED];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_bsn_ip_fragmentation_masked_init(obj, version, bytes, 0);
    of_oxm_bsn_ip_fragmentation_masked_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_bsn_ip_fragmentation_masked.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_bsn_ip_fragmentation_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_BSN_IP_FRAGMENTATION_MASKED] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_BSN_IP_FRAGMENTATION_MASKED;
...
/**
 * Get value from an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param value Pointer to the child object of type
 * uint8_t to be filled out.
 *
 */
    ...
    uint8_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_BSN_IP_FRAGMENTATION_MASKED);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param value The value to write into the object
 */
void
of_oxm_bsn_ip_fragmentation_masked_value_set(
    of_oxm_bsn_ip_fragmentation_masked_t *obj,
    uint8_t value)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get value_mask from an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param value_mask Pointer to the child object of type
 * uint8_t to be filled out.
 *
...
/**
 * Set value_mask in an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_ip_fragmentation_masked.
 * @param value_mask The value to write into the object
 */
void
of_oxm_bsn_ip_fragmentation_masked_value_mask_set(
    of_oxm_bsn_ip_fragmentation_masked_t *obj,
    uint8_t value_mask)
{
    of_wire_buffer_t *wbuf;
...
of_oxm_bsn_l3_interface_class_id_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_L3_INTERFACE_CLASS_ID];
...
void
of_oxm_bsn_l3_interface_class_id_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_l3_interface_class_id_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED];
...
void
of_oxm_bsn_l3_interface_class_id_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_l3_src_class_id_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_L3_SRC_CLASS_ID];
...
void
of_oxm_bsn_l3_src_class_id_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_l3_src_class_id_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED];
...
void
of_oxm_bsn_l3_src_class_id_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_lag_id_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_LAG_ID];
...
void
of_oxm_bsn_lag_id_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_lag_id_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_LAG_ID_MASKED];
...
void
of_oxm_bsn_lag_id_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_tcp_flags_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_TCP_FLAGS];
...
void
of_oxm_bsn_tcp_flags_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_oxm_bsn_tcp_flags_masked_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
...
/**
 * \defgroup of_oxm_bsn_tcp_flags_masked of_oxm_bsn_tcp_flags_masked
 */

/**
 * Create a new of_oxm_bsn_tcp_flags_masked object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_oxm_bsn_tcp_flags_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_TCP_FLAGS_MASKED];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_bsn_tcp_flags_masked_init(obj, version, bytes, 0);
    of_oxm_bsn_tcp_flags_masked_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_bsn_tcp_flags_masked.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_bsn_tcp_flags_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_BSN_TCP_FLAGS_MASKED] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_BSN_TCP_FLAGS_MASKED;
...
/**
 * Get value from an object of type of_oxm_bsn_tcp_flags_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_tcp_flags_masked.
 * @param value Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
    ...
    uint16_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_BSN_TCP_FLAGS_MASKED);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_bsn_tcp_flags_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_tcp_flags_masked.
 * @param value The value to write into the object
 */
void
of_oxm_bsn_tcp_flags_masked_value_set(
    of_oxm_bsn_tcp_flags_masked_t *obj,
    uint16_t value)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get value_mask from an object of type of_oxm_bsn_tcp_flags_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_tcp_flags_masked.
 * @param value_mask Pointer to the child object of type
 * uint16_t to be filled out.
 *
...
/**
 * Set value_mask in an object of type of_oxm_bsn_tcp_flags_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_tcp_flags_masked.
 * @param value_mask The value to write into the object
 */
void
of_oxm_bsn_tcp_flags_masked_value_mask_set(
    of_oxm_bsn_tcp_flags_masked_t *obj,
    uint16_t value_mask)
{
    of_wire_buffer_t *wbuf;
...
of_oxm_bsn_udf0_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF0];
...
void
of_oxm_bsn_udf0_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf0_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF0_MASKED];
...
void
of_oxm_bsn_udf0_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf1_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF1];
...
void
of_oxm_bsn_udf1_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf1_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF1_MASKED];
...
void
of_oxm_bsn_udf1_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf2_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF2];
...
void
of_oxm_bsn_udf2_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf2_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF2_MASKED];
...
void
of_oxm_bsn_udf2_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf3_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF3];
...
void
of_oxm_bsn_udf3_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf3_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF3_MASKED];
...
void
of_oxm_bsn_udf3_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf4_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF4];
...
void
of_oxm_bsn_udf4_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf4_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF4_MASKED];
...
void
of_oxm_bsn_udf4_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf5_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF5];
...
void
of_oxm_bsn_udf5_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf5_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF5_MASKED];
...
void
of_oxm_bsn_udf5_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf6_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF6];
...
void
of_oxm_bsn_udf6_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf6_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF6_MASKED];
...
void
of_oxm_bsn_udf6_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf7_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF7];
...
void
of_oxm_bsn_udf7_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_udf7_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_UDF7_MASKED];
...
void
of_oxm_bsn_udf7_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_oxm_bsn_vlan_xlate_port_group_id_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
...
/**
 * \defgroup of_oxm_bsn_vlan_xlate_port_group_id of_oxm_bsn_vlan_xlate_port_group_id
 */

/**
 * Create a new of_oxm_bsn_vlan_xlate_port_group_id object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
...
of_oxm_bsn_vlan_xlate_port_group_id_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_bsn_vlan_xlate_port_group_id_init(obj, version, bytes, 0);
    of_oxm_bsn_vlan_xlate_port_group_id_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_bsn_vlan_xlate_port_group_id.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_bsn_vlan_xlate_port_group_id_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID;
...
/**
 * Get value from an object of type of_oxm_bsn_vlan_xlate_port_group_id.
 * @param obj Pointer to an object of type of_oxm_bsn_vlan_xlate_port_group_id.
 * @param value Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
    ...
    uint32_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_bsn_vlan_xlate_port_group_id.
 * @param obj Pointer to an object of type of_oxm_bsn_vlan_xlate_port_group_id.
 * @param value The value to write into the object
 */
void
of_oxm_bsn_vlan_xlate_port_group_id_value_set(
    of_oxm_bsn_vlan_xlate_port_group_id_t *obj,
    uint32_t value)
{
    of_wire_buffer_t *wbuf;
