...
void
of_oxm_bsn_vlan_xlate_port_group_id_masked_push_wire_types(of_object_t *obj)
{
...
/**
 * \defgroup of_oxm_bsn_vlan_xlate_port_group_id_masked of_oxm_bsn_vlan_xlate_port_group_id_masked
 */

/**
 * Create a new of_oxm_bsn_vlan_xlate_port_group_id_masked object
 *
...
of_oxm_bsn_vlan_xlate_port_group_id_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_bsn_vlan_xlate_port_group_id_masked_init(obj, version, bytes, 0);
    of_oxm_bsn_vlan_xlate_port_group_id_masked_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 *
...
void
of_oxm_bsn_vlan_xlate_port_group_id_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED] >= 0);
    if (clean_wire) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED;
...
/**
 * Get value from an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
    ...
    uint32_t *value)
{
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED);
    ver = obj->version;
...
/**
 * Set value in an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 * @param value The value to write into the object
 */
void
of_oxm_bsn_vlan_xlate_port_group_id_masked_value_set(
    of_oxm_bsn_vlan_xlate_port_group_id_masked_t *obj,
    uint32_t value)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get value_mask from an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
...
/**
 * Set value_mask in an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 * @param obj Pointer to an object of type of_oxm_bsn_vlan_xlate_port_group_id_masked.
 * @param value_mask The value to write into the object
 */
void
of_oxm_bsn_vlan_xlate_port_group_id_masked_value_mask_set(
    of_oxm_bsn_vlan_xlate_port_group_id_masked_t *obj,
    uint32_t value_mask)
{
    of_wire_buffer_t *wbuf;
...
of_oxm_bsn_vrf_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_VRF];
...
void
of_oxm_bsn_vrf_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_oxm_bsn_vrf_masked_new(of_version_t version)
{
    ...
    bytes = of_object_fixed_len[version][OF_OXM_BSN_VRF_MASKED];
...
void
of_oxm_bsn_vrf_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_oxm_encap_eth_dst_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x1f406); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_encap_eth_dst of_oxm_encap_eth_dst
 */

/**
 * Create a new of_oxm_encap_eth_dst object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_oxm_encap_eth_dst
 */

of_object_t *
of_oxm_encap_eth_dst_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_OXM_ENCAP_ETH_DST];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_encap_eth_dst_init(obj, version, bytes, 0);
    of_oxm_encap_eth_dst_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_encap_eth_dst.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_encap_eth_dst_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_ENCAP_ETH_DST] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_ENCAP_ETH_DST;
...
/**
 * Get value from an object of type of_oxm_encap_eth_dst.
 * @param obj Pointer to an object of type of_oxm_encap_eth_dst.
 * @param value Pointer to the child object of type
 * of_mac_addr_t to be filled out.
 *
 */
void
of_oxm_encap_eth_dst_value_get(
    of_oxm_encap_eth_dst_t *obj,
    of_mac_addr_t *value)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_ENCAP_ETH_DST);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_encap_eth_dst.
 * @param obj Pointer to an object of type of_oxm_encap_eth_dst.
 * @param value The value to write into the object
 */
void
of_oxm_encap_eth_dst_value_set(
    of_oxm_encap_eth_dst_t *obj,
    of_mac_addr_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_oxm_encap_eth_dst_masked_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x1f50c); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_encap_eth_dst_masked of_oxm_encap_eth_dst_masked
 */

/**
 * Create a new of_oxm_encap_eth_dst_masked object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_oxm_encap_eth_dst_masked
 */

of_object_t *
of_oxm_encap_eth_dst_masked_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_OXM_ENCAP_ETH_DST_MASKED];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_encap_eth_dst_masked_init(obj, version, bytes, 0);
    of_oxm_encap_eth_dst_masked_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_encap_eth_dst_masked.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_encap_eth_dst_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_ENCAP_ETH_DST_MASKED] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_ENCAP_ETH_DST_MASKED;
...
/**
 * Get value from an object of type of_oxm_encap_eth_dst_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_dst_masked.
 * @param value Pointer to the child object of type
 * of_mac_addr_t to be filled out.
 *
 */
void
of_oxm_encap_eth_dst_masked_value_get(
    of_oxm_encap_eth_dst_masked_t *obj,
    of_mac_addr_t *value)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_ENCAP_ETH_DST_MASKED);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_encap_eth_dst_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_dst_masked.
 * @param value The value to write into the object
 */
void
of_oxm_encap_eth_dst_masked_value_set(
    of_oxm_encap_eth_dst_masked_t *obj,
    of_mac_addr_t value)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get value_mask from an object of type of_oxm_encap_eth_dst_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_dst_masked.
 * @param value_mask Pointer to the child object of type
 * of_mac_addr_t to be filled out.
 *
 */
void
of_oxm_encap_eth_dst_masked_value_mask_get(
    of_oxm_encap_eth_dst_masked_t *obj,
...
/**
 * Set value_mask in an object of type of_oxm_encap_eth_dst_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_dst_masked.
 * @param value_mask The value to write into the object
 */
void
of_oxm_encap_eth_dst_masked_value_mask_set(
    of_oxm_encap_eth_dst_masked_t *obj,
    of_mac_addr_t value_mask)
{
    of_wire_buffer_t *wbuf;
...
void
of_oxm_encap_eth_src_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x1f206); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_encap_eth_src of_oxm_encap_eth_src
 */

/**
 * Create a new of_oxm_encap_eth_src object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_oxm_encap_eth_src
 */

of_object_t *
of_oxm_encap_eth_src_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_OXM_ENCAP_ETH_SRC];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_encap_eth_src_init(obj, version, bytes, 0);
    of_oxm_encap_eth_src_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_encap_eth_src.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_encap_eth_src_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_ENCAP_ETH_SRC] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_ENCAP_ETH_SRC;
...
/**
 * Get value from an object of type of_oxm_encap_eth_src.
 * @param obj Pointer to an object of type of_oxm_encap_eth_src.
 * @param value Pointer to the child object of type
 * of_mac_addr_t to be filled out.
 *
 */
void
of_oxm_encap_eth_src_value_get(
    of_oxm_encap_eth_src_t *obj,
    of_mac_addr_t *value)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_ENCAP_ETH_SRC);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_encap_eth_src.
 * @param obj Pointer to an object of type of_oxm_encap_eth_src.
 * @param value The value to write into the object
 */
void
of_oxm_encap_eth_src_value_set(
    of_oxm_encap_eth_src_t *obj,
    of_mac_addr_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_oxm_encap_eth_src_masked_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x1f30c); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_encap_eth_src_masked of_oxm_encap_eth_src_masked
 */

/**
 * Create a new of_oxm_encap_eth_src_masked object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_oxm_encap_eth_src_masked
 */

of_object_t *
of_oxm_encap_eth_src_masked_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_OXM_ENCAP_ETH_SRC_MASKED];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_encap_eth_src_masked_init(obj, version, bytes, 0);
    of_oxm_encap_eth_src_masked_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_encap_eth_src_masked.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_encap_eth_src_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_ENCAP_ETH_SRC_MASKED] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_ENCAP_ETH_SRC_MASKED;
...
/**
 * Get value from an object of type of_oxm_encap_eth_src_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_src_masked.
 * @param value Pointer to the child object of type
 * of_mac_addr_t to be filled out.
 *
 */
void
of_oxm_encap_eth_src_masked_value_get(
    of_oxm_encap_eth_src_masked_t *obj,
    of_mac_addr_t *value)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_ENCAP_ETH_SRC_MASKED);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_encap_eth_src_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_src_masked.
 * @param value The value to write into the object
 */
void
of_oxm_encap_eth_src_masked_value_set(
    of_oxm_encap_eth_src_masked_t *obj,
    of_mac_addr_t value)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get value_mask from an object of type of_oxm_encap_eth_src_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_src_masked.
 * @param value_mask Pointer to the child object of type
 * of_mac_addr_t to be filled out.
 *
 */
void
of_oxm_encap_eth_src_masked_value_mask_get(
    of_oxm_encap_eth_src_masked_t *obj,
    of_mac_addr_t *value_mask)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set value_mask in an object of type of_oxm_encap_eth_src_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_src_masked.
 * @param value_mask The value to write into the object
 */
void
of_oxm_encap_eth_src_masked_value_mask_set(
    of_oxm_encap_eth_src_masked_t *obj,
    of_mac_addr_t value_mask)
{
    of_wire_buffer_t *wbuf;
...
void
of_oxm_encap_eth_type_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x1f602); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_encap_eth_type of_oxm_encap_eth_type
 */

/**
 * Create a new of_oxm_encap_eth_type object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_oxm_encap_eth_type
 */

of_object_t *
of_oxm_encap_eth_type_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_OXM_ENCAP_ETH_TYPE];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_encap_eth_type_init(obj, version, bytes, 0);
    of_oxm_encap_eth_type_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_encap_eth_type.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_encap_eth_type_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_ENCAP_ETH_TYPE] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_ENCAP_ETH_TYPE;
...
/**
 * Get value from an object of type of_oxm_encap_eth_type.
 * @param obj Pointer to an object of type of_oxm_encap_eth_type.
 * @param value Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_oxm_encap_eth_type_value_get(
    of_oxm_encap_eth_type_t *obj,
    uint16_t *value)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_ENCAP_ETH_TYPE);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_encap_eth_type.
 * @param obj Pointer to an object of type of_oxm_encap_eth_type.
 * @param value The value to write into the object
 */
void
of_oxm_encap_eth_type_value_set(
    of_oxm_encap_eth_type_t *obj,
    uint16_t value)
{
    of_wire_buffer_t *wbuf;
...
void
of_oxm_encap_eth_type_masked_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_2:
    case OF_VERSION_1_3:
    case OF_VERSION_1_4:
        *(uint32_t *)(buf + 0) = U32_HTON(0x1f704); /* type_len */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_oxm_encap_eth_type_masked of_oxm_encap_eth_type_masked
 */

/**
 * Create a new of_oxm_encap_eth_type_masked object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_oxm_encap_eth_type_masked
 */

of_object_t *
of_oxm_encap_eth_type_masked_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_OXM_ENCAP_ETH_TYPE_MASKED];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_oxm_encap_eth_type_masked_init(obj, version, bytes, 0);
    of_oxm_encap_eth_type_masked_push_wire_types(obj);

    return obj;
}

/**
 * Initialize an object of type of_oxm_encap_eth_type_masked.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_oxm_encap_eth_type_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_OXM_ENCAP_ETH_TYPE_MASKED] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_OXM_ENCAP_ETH_TYPE_MASKED;
...
/**
 * Get value from an object of type of_oxm_encap_eth_type_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_type_masked.
 * @param value Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_oxm_encap_eth_type_masked_value_get(
    of_oxm_encap_eth_type_masked_t *obj,
    uint16_t *value)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_OXM_ENCAP_ETH_TYPE_MASKED);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set value in an object of type of_oxm_encap_eth_type_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_type_masked.
 * @param value The value to write into the object
 */
void
of_oxm_encap_eth_type_masked_value_set(
    of_oxm_encap_eth_type_masked_t *obj,
    uint16_t value)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get value_mask from an object of type of_oxm_encap_eth_type_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_type_masked.
 * @param value_mask Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_oxm_encap_eth_type_masked_value_mask_get(
    of_oxm_encap_eth_type_masked_t *obj,
    uint16_t *value_mask)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set value_mask in an object of type of_oxm_encap_eth_type_masked.
 * @param obj Pointer to an object of type of_oxm_encap_eth_type_masked.
 * @param value_mask The value to write into the object
 */
void
of_oxm_encap_eth_type_masked_value_mask_set(
    of_oxm_encap_eth_type_masked_t *obj,
    uint16_t value_mask)
{
    of_wire_buffer_t *wbuf;
