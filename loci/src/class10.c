...
void
of_oxm_vlan_vid_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_oxm_vlan_vid_masked_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_queue_prop_experimenter_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
void
of_queue_prop_max_rate_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
...
of_action_id_experimenter_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        case 0x5c16c7:
            ...
            break;
        case 0x748771:
            *id = OF_ACTION_ID_CIRCUIT;
            break;
        case 0xff000088:
            *id = OF_ACTION_ID_OPLINK_ATT;
            break;
        default:
...
void
of_action_circuit_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
        *(uint16_t *)(buf + 0) = U16_HTON(0xffff); /* type */
        *(uint32_t *)(buf + 4) = U32_HTON(0x748771); /* experimenter */
        *(uint16_t *)(buf + 8) = U16_HTON(0x19); /* subtype */
        *(uint16_t *)(buf + 10) = U16_HTON(0x10); /* hlength */
        break;
    default:
        UNREACHABLE();
    }
...
/**
 * \defgroup of_action_circuit of_action_circuit
 */

/**
 * Create a new of_action_circuit object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_action_circuit
 */

of_object_t *
of_action_circuit_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_CIRCUIT];

    if ((obj = of_object_new(OF_WIRE_BUFFER_MAX_LENGTH)) == NULL) {
        return NULL;
    }

    of_action_circuit_init(obj, version, bytes, 0);
    of_action_circuit_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_action_circuit.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_circuit_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_CIRCUIT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_CIRCUIT;
...
/**
 * Get experimenter from an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_circuit_experimenter_get(
    of_action_circuit_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_CIRCUIT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
 * @param experimenter The value to write into the object
 */
void
of_action_circuit_experimenter_set(
    of_action_circuit_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
...
/**
 * Set subtype in an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
 * @param subtype The value to write into the object
 */
void
of_action_circuit_subtype_set(
    of_action_circuit_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get hlength from an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
 * @param hlength Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_circuit_hlength_get(
    of_action_circuit_t *obj,
    uint16_t *hlength)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u16_get(wbuf, abs_offset, hlength);
...
/**
 * Set hlength in an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
 * @param hlength The value to write into the object
 */
void
of_action_circuit_hlength_set(
    of_action_circuit_t *obj,
    uint16_t hlength)
{
    of_wire_buffer_t *wbuf;
    ...
    abs_offset = OF_OBJECT_ABSOLUTE_OFFSET(obj, offset);
    LOCI_ASSERT(abs_offset >= 0);
    of_wire_buffer_u16_set(wbuf, abs_offset, hlength);
...
/**
 * Bind an object of type of_oxm_t to the parent of type of_action_circuit for
 * member field
 * @param obj Pointer to an object of type of_action_circuit.
 ...
 * a of_action_circuit instance.
 *
 * @param obj Pointer to the source of type of_action_circuit_t
 * @returns A pointer to a new instance of type of_oxm_t whose contents
 * match that of field from source
 * @returns NULL if an error occurs
 */
of_oxm_t *
of_action_circuit_field_get(of_action_circuit_t *obj) {
    of_oxm_t _field;
    of_oxm_t *_field_ptr;

    of_action_circuit_field_bind(obj, &_field);
    _field_ptr = (of_oxm_t *)of_object_dup(&_field);
    return _field_ptr;
}

/**
 * Set field in an object of type of_action_circuit.
 * @param obj Pointer to an object of type of_action_circuit.
...
void
of_action_id_circuit_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_circuit of_action_id_circuit
 */

/**
 * Create a new of_action_id_circuit object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_action_id_circuit
 */

of_object_t *
of_action_id_circuit_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_CIRCUIT];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_action_id_circuit_init(obj, version, bytes, 0);
    of_action_id_circuit_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_action_id_circuit.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_circuit_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_CIRCUIT] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_CIRCUIT;
...
/**
 * Get experimenter from an object of type of_action_id_circuit.
 * @param obj Pointer to an object of type of_action_id_circuit.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_circuit_experimenter_get(
    of_action_id_circuit_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_CIRCUIT);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_circuit.
 * @param obj Pointer to an object of type of_action_id_circuit.
 * @param experimenter The value to write into the object
 */
void
of_action_id_circuit_experimenter_set(
    of_action_id_circuit_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_circuit.
 * @param obj Pointer to an object of type of_action_id_circuit.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_circuit_subtype_get(
    of_action_id_circuit_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_circuit.
 * @param obj Pointer to an object of type of_action_id_circuit.
 * @param subtype The value to write into the object
 */
void
of_action_id_circuit_subtype_set(
    of_action_id_circuit_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get hlength from an object of type of_action_id_circuit.
 * @param obj Pointer to an object of type of_action_id_circuit.
 * @param hlength Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_circuit_hlength_get(
    of_action_id_circuit_t *obj,
    uint16_t *hlength)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set hlength in an object of type of_action_id_circuit.
 * @param obj Pointer to an object of type of_action_id_circuit.
 * @param hlength The value to write into the object
 */
void
of_action_id_circuit_hlength_set(
    of_action_id_circuit_t *obj,
    uint16_t hlength)
{
    of_wire_buffer_t *wbuf;
...
of_action_id_nicira_wire_object_id_get(of_object_t *obj, of_object_id_t *id)
{
    ...
    case OF_VERSION_1_3: {
        ...
        switch (value) {
        case 0x1:
            *id = OF_ACTION_ID_NICIRA_RESUBMIT;
            break;
        case 0x6:
            *id = OF_ACTION_ID_NICIRA_MOVE;
            break;
        case 0xe:
            *id = OF_ACTION_ID_NICIRA_RESUBMIT_TABLE;
            break;
        case 0x12:
            *id = OF_ACTION_ID_NICIRA_DEC_TTL;
            break;
        case 0x26:
            *id = OF_ACTION_ID_NICIRA_PUSH_NSH;
            break;
        case 0x27:
            *id = OF_ACTION_ID_NICIRA_POP_NSH;
            break;
        default:
...
void
of_action_id_nicira_move_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_nicira_move of_action_id_nicira_move
 */

/**
 * Create a new of_action_id_nicira_move object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_action_id_nicira_move
 */

of_object_t *
of_action_id_nicira_move_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_NICIRA_MOVE];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_action_id_nicira_move_init(obj, version, bytes, 0);
    of_action_id_nicira_move_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_action_id_nicira_move.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_nicira_move_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_NICIRA_MOVE] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_NICIRA_MOVE;
...
/**
 * Get experimenter from an object of type of_action_id_nicira_move.
 * @param obj Pointer to an object of type of_action_id_nicira_move.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_nicira_move_experimenter_get(
    of_action_id_nicira_move_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_NICIRA_MOVE);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_nicira_move.
 * @param obj Pointer to an object of type of_action_id_nicira_move.
 * @param experimenter The value to write into the object
 */
void
of_action_id_nicira_move_experimenter_set(
    of_action_id_nicira_move_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_nicira_move.
 * @param obj Pointer to an object of type of_action_id_nicira_move.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_nicira_move_subtype_get(
    of_action_id_nicira_move_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_nicira_move.
 * @param obj Pointer to an object of type of_action_id_nicira_move.
 * @param subtype The value to write into the object
 */
void
of_action_id_nicira_move_subtype_set(
    of_action_id_nicira_move_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
void
of_action_id_nicira_pop_nsh_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_nicira_pop_nsh of_action_id_nicira_pop_nsh
 */

/**
 * Create a new of_action_id_nicira_pop_nsh object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_action_id_nicira_pop_nsh
 */

of_object_t *
of_action_id_nicira_pop_nsh_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_NICIRA_POP_NSH];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_action_id_nicira_pop_nsh_init(obj, version, bytes, 0);
    of_action_id_nicira_pop_nsh_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_action_id_nicira_pop_nsh.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_nicira_pop_nsh_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_NICIRA_POP_NSH] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_NICIRA_POP_NSH;
...
/**
 * Get experimenter from an object of type of_action_id_nicira_pop_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_pop_nsh.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_nicira_pop_nsh_experimenter_get(
    of_action_id_nicira_pop_nsh_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_NICIRA_POP_NSH);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_nicira_pop_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_pop_nsh.
 * @param experimenter The value to write into the object
 */
void
of_action_id_nicira_pop_nsh_experimenter_set(
    of_action_id_nicira_pop_nsh_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_nicira_pop_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_pop_nsh.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_nicira_pop_nsh_subtype_get(
    of_action_id_nicira_pop_nsh_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_nicira_pop_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_pop_nsh.
 * @param subtype The value to write into the object
 */
void
of_action_id_nicira_pop_nsh_subtype_set(
    of_action_id_nicira_pop_nsh_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
...
void
of_action_id_nicira_push_nsh_push_wire_types(of_object_t *obj)
{
    unsigned char *buf = OF_OBJECT_BUFFER_INDEX(obj, 0);
    switch (obj->version) {
    case OF_VERSION_1_3:
...
/**
 * \defgroup of_action_id_nicira_push_nsh of_action_id_nicira_push_nsh
 */

/**
 * Create a new of_action_id_nicira_push_nsh object
 *
 * @param version The wire version to use for the object
 * @return Pointer to the newly create object or NULL on error
 *
 ...
 * a new underlying wire buffer.
 *
 * \ingroup of_action_id_nicira_push_nsh
 */

of_object_t *
of_action_id_nicira_push_nsh_new(of_version_t version)
{
    of_object_t *obj;
    int bytes;

    bytes = of_object_fixed_len[version][OF_ACTION_ID_NICIRA_PUSH_NSH];

    if ((obj = of_object_new(bytes)) == NULL) {
        return NULL;
    }

    of_action_id_nicira_push_nsh_init(obj, version, bytes, 0);
    of_action_id_nicira_push_nsh_push_wire_types(obj);
    of_tlv16_wire_length_set(obj, obj->length);
...
/**
 * Initialize an object of type of_action_id_nicira_push_nsh.
 *
 * @param obj Pointer to the object to initialize
 * @param version The wire version to use for the object
 * @param bytes How many bytes in the object
...
void
of_action_id_nicira_push_nsh_init(of_object_t *obj,
    of_version_t version, int bytes, int clean_wire)
{
    LOCI_ASSERT(of_object_fixed_len[version][OF_ACTION_ID_NICIRA_PUSH_NSH] >= 0);
    if (clean_wire) {
        MEMSET(obj, 0, sizeof(*obj));
    }
    if (bytes < 0) {
    ...
    obj->version = version;
    obj->length = bytes;
    obj->object_id = OF_ACTION_ID_NICIRA_PUSH_NSH;
...
/**
 * Get experimenter from an object of type of_action_id_nicira_push_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_push_nsh.
 * @param experimenter Pointer to the child object of type
 * uint32_t to be filled out.
 *
 */
void
of_action_id_nicira_push_nsh_experimenter_get(
    of_action_id_nicira_push_nsh_t *obj,
    uint32_t *experimenter)
{
    of_wire_buffer_t *wbuf;
    int offset = 0; /* Offset of value relative to the start obj */
    ...
    LOCI_ASSERT(obj->object_id == OF_ACTION_ID_NICIRA_PUSH_NSH);
    ver = obj->version;
    wbuf = OF_OBJECT_TO_WBUF(obj);
    LOCI_ASSERT(wbuf != NULL);
...
/**
 * Set experimenter in an object of type of_action_id_nicira_push_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_push_nsh.
 * @param experimenter The value to write into the object
 */
void
of_action_id_nicira_push_nsh_experimenter_set(
    of_action_id_nicira_push_nsh_t *obj,
    uint32_t experimenter)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Get subtype from an object of type of_action_id_nicira_push_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_push_nsh.
 * @param subtype Pointer to the child object of type
 * uint16_t to be filled out.
 *
 */
void
of_action_id_nicira_push_nsh_subtype_get(
    of_action_id_nicira_push_nsh_t *obj,
    uint16_t *subtype)
{
    of_wire_buffer_t *wbuf;
...
/**
 * Set subtype in an object of type of_action_id_nicira_push_nsh.
 * @param obj Pointer to an object of type of_action_id_nicira_push_nsh.
 * @param subtype The value to write into the object
 */
void
of_action_id_nicira_push_nsh_subtype_set(
    of_action_id_nicira_push_nsh_t *obj,
    uint16_t subtype)
{
    of_wire_buffer_t *wbuf;
