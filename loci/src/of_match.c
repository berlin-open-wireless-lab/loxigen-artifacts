...
of_match_v1_compat_check(of_match_t *match)
{
    ...
    if (OF_MATCH_MASK_EXP_OCH_SIGTYPE_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_EXP_ODU_SIGID_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGID_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_TUN_FLAGS_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_TUN_GPE_FLAGS_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_TUN_GBP_ID_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_EXP_OCH_SIGID_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_EXP_ODU_SIGTYPE_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_NSH_C4_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_NSH_C1_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_NSH_C3_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_NSH_C2_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_OCH_SIGATT_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_ENCAP_ETH_DST_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_NSI_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_NSP_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_ENCAP_ETH_TYPE_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_BASIC_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_OCH_SIGATT_BASIC_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_TUN_GPE_NP_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_ENCAP_ETH_SRC_ACTIVE_TEST(match)) {
        return 0;
    }

    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGID_BASIC_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_NSH_MDTYPE_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_TUN_GBP_FLAGS_ACTIVE_TEST(match)) {
        return 0;
    }
    ...
    if (OF_MATCH_MASK_NSH_NP_ACTIVE_TEST(match)) {
        return 0;
    }
...
populate_oxm_list(of_match_t *src, of_list_oxm_t *oxm_list)
{
    ...
    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_BASIC_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_BASIC_EXACT_TEST(src)) {
            of_oxm_circuit_och_sigtype_basic_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigtype_basic_masked_value_set(&elt,
                   src->fields.circuit_och_sigtype_basic);
            of_oxm_circuit_och_sigtype_basic_masked_value_mask_set(&elt,
                   src->masks.circuit_och_sigtype_basic);
        } else {  /* Active, but not masked */
            of_oxm_circuit_och_sigtype_basic_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigtype_basic_value_set(&elt, src->fields.circuit_och_sigtype_basic);
        }
    }
    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGID_BASIC_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_CIRCUIT_OCH_SIGID_BASIC_EXACT_TEST(src)) {
            of_oxm_circuit_och_sigid_basic_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigid_basic_masked_value_set(&elt,
                   src->fields.circuit_och_sigid_basic);
            of_oxm_circuit_och_sigid_basic_masked_value_mask_set(&elt,
                   src->masks.circuit_och_sigid_basic);
        } else {  /* Active, but not masked */
            of_oxm_circuit_och_sigid_basic_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigid_basic_value_set(&elt, src->fields.circuit_och_sigid_basic);
        }
    }
    if (OF_MATCH_MASK_OCH_SIGATT_BASIC_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_OCH_SIGATT_BASIC_EXACT_TEST(src)) {
            of_oxm_och_sigatt_basic_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_och_sigatt_basic_masked_value_set(&elt,
                   src->fields.och_sigatt_basic);
            of_oxm_och_sigatt_basic_masked_value_mask_set(&elt,
                   src->masks.och_sigatt_basic);
        } else {  /* Active, but not masked */
            of_oxm_och_sigatt_basic_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_och_sigatt_basic_value_set(&elt, src->fields.och_sigatt_basic);
        }
    }
    ...
    if (OF_MATCH_MASK_TUN_GBP_ID_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_TUN_GBP_ID_EXACT_TEST(src)) {
            of_oxm_tun_gbp_id_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gbp_id_masked_value_set(&elt,
                   src->fields.tun_gbp_id);
            of_oxm_tun_gbp_id_masked_value_mask_set(&elt,
                   src->masks.tun_gbp_id);
        } else {  /* Active, but not masked */
            of_oxm_tun_gbp_id_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gbp_id_value_set(&elt, src->fields.tun_gbp_id);
        }
    }
    if (OF_MATCH_MASK_TUN_GBP_FLAGS_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_TUN_GBP_FLAGS_EXACT_TEST(src)) {
            of_oxm_tun_gbp_flags_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gbp_flags_masked_value_set(&elt,
                   src->fields.tun_gbp_flags);
            of_oxm_tun_gbp_flags_masked_value_mask_set(&elt,
                   src->masks.tun_gbp_flags);
        } else {  /* Active, but not masked */
            of_oxm_tun_gbp_flags_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gbp_flags_value_set(&elt, src->fields.tun_gbp_flags);
        }
    }
    if (OF_MATCH_MASK_TUN_FLAGS_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_TUN_FLAGS_EXACT_TEST(src)) {
            of_oxm_tun_flags_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_flags_masked_value_set(&elt,
                   src->fields.tun_flags);
            of_oxm_tun_flags_masked_value_mask_set(&elt,
                   src->masks.tun_flags);
        } else {  /* Active, but not masked */
            of_oxm_tun_flags_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_flags_value_set(&elt, src->fields.tun_flags);
        }
    }
    if (OF_MATCH_MASK_TUN_GPE_NP_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_TUN_GPE_NP_EXACT_TEST(src)) {
            of_oxm_tun_gpe_np_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gpe_np_masked_value_set(&elt,
                   src->fields.tun_gpe_np);
            of_oxm_tun_gpe_np_masked_value_mask_set(&elt,
                   src->masks.tun_gpe_np);
        } else {  /* Active, but not masked */
            of_oxm_tun_gpe_np_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gpe_np_value_set(&elt, src->fields.tun_gpe_np);
        }
    }
    if (OF_MATCH_MASK_TUN_GPE_FLAGS_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_TUN_GPE_FLAGS_EXACT_TEST(src)) {
            of_oxm_tun_gpe_flags_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gpe_flags_masked_value_set(&elt,
                   src->fields.tun_gpe_flags);
            of_oxm_tun_gpe_flags_masked_value_mask_set(&elt,
                   src->masks.tun_gpe_flags);
        } else {  /* Active, but not masked */
            of_oxm_tun_gpe_flags_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_tun_gpe_flags_value_set(&elt, src->fields.tun_gpe_flags);
        }
    }
    if (OF_MATCH_MASK_NSP_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSP_EXACT_TEST(src)) {
            of_oxm_nsp_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsp_masked_value_set(&elt,
                   src->fields.nsp);
            of_oxm_nsp_masked_value_mask_set(&elt,
                   src->masks.nsp);
        } else {  /* Active, but not masked */
            of_oxm_nsp_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsp_value_set(&elt, src->fields.nsp);
        }
    }
    if (OF_MATCH_MASK_NSI_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSI_EXACT_TEST(src)) {
            of_oxm_nsi_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsi_masked_value_set(&elt,
                   src->fields.nsi);
            of_oxm_nsi_masked_value_mask_set(&elt,
                   src->masks.nsi);
        } else {  /* Active, but not masked */
            of_oxm_nsi_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsi_value_set(&elt, src->fields.nsi);
        }
    }
    if (OF_MATCH_MASK_NSH_C1_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSH_C1_EXACT_TEST(src)) {
            of_oxm_nsh_c1_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c1_masked_value_set(&elt,
                   src->fields.nsh_c1);
            of_oxm_nsh_c1_masked_value_mask_set(&elt,
                   src->masks.nsh_c1);
        } else {  /* Active, but not masked */
            of_oxm_nsh_c1_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c1_value_set(&elt, src->fields.nsh_c1);
        }
    }
    if (OF_MATCH_MASK_NSH_C2_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSH_C2_EXACT_TEST(src)) {
            of_oxm_nsh_c2_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c2_masked_value_set(&elt,
                   src->fields.nsh_c2);
            of_oxm_nsh_c2_masked_value_mask_set(&elt,
                   src->masks.nsh_c2);
        } else {  /* Active, but not masked */
            of_oxm_nsh_c2_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c2_value_set(&elt, src->fields.nsh_c2);
        }
    }
    if (OF_MATCH_MASK_NSH_C3_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSH_C3_EXACT_TEST(src)) {
            of_oxm_nsh_c3_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c3_masked_value_set(&elt,
                   src->fields.nsh_c3);
            of_oxm_nsh_c3_masked_value_mask_set(&elt,
                   src->masks.nsh_c3);
        } else {  /* Active, but not masked */
            of_oxm_nsh_c3_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c3_value_set(&elt, src->fields.nsh_c3);
        }
    }
    if (OF_MATCH_MASK_NSH_C4_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSH_C4_EXACT_TEST(src)) {
            of_oxm_nsh_c4_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c4_masked_value_set(&elt,
                   src->fields.nsh_c4);
            of_oxm_nsh_c4_masked_value_mask_set(&elt,
                   src->masks.nsh_c4);
        } else {  /* Active, but not masked */
            of_oxm_nsh_c4_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_c4_value_set(&elt, src->fields.nsh_c4);
        }
    }
    if (OF_MATCH_MASK_NSH_MDTYPE_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSH_MDTYPE_EXACT_TEST(src)) {
            of_oxm_nsh_mdtype_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_mdtype_masked_value_set(&elt,
                   src->fields.nsh_mdtype);
            of_oxm_nsh_mdtype_masked_value_mask_set(&elt,
                   src->masks.nsh_mdtype);
        } else {  /* Active, but not masked */
            of_oxm_nsh_mdtype_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_mdtype_value_set(&elt, src->fields.nsh_mdtype);
        }
    }
    if (OF_MATCH_MASK_NSH_NP_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_NSH_NP_EXACT_TEST(src)) {
            of_oxm_nsh_np_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_np_masked_value_set(&elt,
                   src->fields.nsh_np);
            of_oxm_nsh_np_masked_value_mask_set(&elt,
                   src->masks.nsh_np);
        } else {  /* Active, but not masked */
            of_oxm_nsh_np_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_nsh_np_value_set(&elt, src->fields.nsh_np);
        }
    }
    if (OF_MATCH_MASK_ENCAP_ETH_SRC_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_ENCAP_ETH_SRC_EXACT_TEST(src)) {
            of_oxm_encap_eth_src_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_encap_eth_src_masked_value_set(&elt,
                   src->fields.encap_eth_src);
            of_oxm_encap_eth_src_masked_value_mask_set(&elt,
                   src->masks.encap_eth_src);
        } else {  /* Active, but not masked */
            of_oxm_encap_eth_src_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_encap_eth_src_value_set(&elt, src->fields.encap_eth_src);
        }
    }
    if (OF_MATCH_MASK_ENCAP_ETH_DST_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_ENCAP_ETH_DST_EXACT_TEST(src)) {
            of_oxm_encap_eth_dst_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_encap_eth_dst_masked_value_set(&elt,
                   src->fields.encap_eth_dst);
            of_oxm_encap_eth_dst_masked_value_mask_set(&elt,
                   src->masks.encap_eth_dst);
        } else {  /* Active, but not masked */
            of_oxm_encap_eth_dst_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_encap_eth_dst_value_set(&elt, src->fields.encap_eth_dst);
        }
    }
    if (OF_MATCH_MASK_ENCAP_ETH_TYPE_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_ENCAP_ETH_TYPE_EXACT_TEST(src)) {
            of_oxm_encap_eth_type_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_encap_eth_type_masked_value_set(&elt,
                   src->fields.encap_eth_type);
            of_oxm_encap_eth_type_masked_value_mask_set(&elt,
                   src->masks.encap_eth_type);
        } else {  /* Active, but not masked */
            of_oxm_encap_eth_type_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_encap_eth_type_value_set(&elt, src->fields.encap_eth_type);
        }
    }
    ...
    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_EXACT_TEST(src)) {
            of_oxm_circuit_och_sigtype_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigtype_masked_value_set(&elt,
                   src->fields.circuit_och_sigtype);
            of_oxm_circuit_och_sigtype_masked_value_mask_set(&elt,
                   src->masks.circuit_och_sigtype);
        } else {  /* Active, but not masked */
            of_oxm_circuit_och_sigtype_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigtype_value_set(&elt, src->fields.circuit_och_sigtype);
        }
    }
    if (OF_MATCH_MASK_CIRCUIT_OCH_SIGID_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_CIRCUIT_OCH_SIGID_EXACT_TEST(src)) {
            of_oxm_circuit_och_sigid_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigid_masked_value_set(&elt,
                   src->fields.circuit_och_sigid);
            of_oxm_circuit_och_sigid_masked_value_mask_set(&elt,
                   src->masks.circuit_och_sigid);
        } else {  /* Active, but not masked */
            of_oxm_circuit_och_sigid_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_circuit_och_sigid_value_set(&elt, src->fields.circuit_och_sigid);
        }
    }
    if (OF_MATCH_MASK_OCH_SIGATT_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_OCH_SIGATT_EXACT_TEST(src)) {
            of_oxm_och_sigatt_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_och_sigatt_masked_value_set(&elt,
                   src->fields.och_sigatt);
            of_oxm_och_sigatt_masked_value_mask_set(&elt,
                   src->masks.och_sigatt);
        } else {  /* Active, but not masked */
            of_oxm_och_sigatt_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_och_sigatt_value_set(&elt, src->fields.och_sigatt);
        }
    }
    if (OF_MATCH_MASK_EXP_ODU_SIGTYPE_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_EXP_ODU_SIGTYPE_EXACT_TEST(src)) {
            of_oxm_exp_odu_sigtype_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_odu_sigtype_masked_value_set(&elt,
                   src->fields.exp_odu_sigtype);
            of_oxm_exp_odu_sigtype_masked_value_mask_set(&elt,
                   src->masks.exp_odu_sigtype);
        } else {  /* Active, but not masked */
            of_oxm_exp_odu_sigtype_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_odu_sigtype_value_set(&elt, src->fields.exp_odu_sigtype);
        }
    }
    if (OF_MATCH_MASK_EXP_ODU_SIGID_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_EXP_ODU_SIGID_EXACT_TEST(src)) {
            of_oxm_exp_odu_sigid_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_odu_sigid_masked_value_set(&elt,
                   src->fields.exp_odu_sigid);
            of_oxm_exp_odu_sigid_masked_value_mask_set(&elt,
                   src->masks.exp_odu_sigid);
        } else {  /* Active, but not masked */
            of_oxm_exp_odu_sigid_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_odu_sigid_value_set(&elt, src->fields.exp_odu_sigid);
        }
    }
    if (OF_MATCH_MASK_EXP_OCH_SIGTYPE_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_EXP_OCH_SIGTYPE_EXACT_TEST(src)) {
            of_oxm_exp_och_sigtype_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_och_sigtype_masked_value_set(&elt,
                   src->fields.exp_och_sigtype);
            of_oxm_exp_och_sigtype_masked_value_mask_set(&elt,
                   src->masks.exp_och_sigtype);
        } else {  /* Active, but not masked */
            of_oxm_exp_och_sigtype_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_och_sigtype_value_set(&elt, src->fields.exp_och_sigtype);
        }
    }
    if (OF_MATCH_MASK_OFDPA_QOS_INDEX_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_OFDPA_QOS_INDEX_EXACT_TEST(src)) {
            of_oxm_ofdpa_qos_index_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_ofdpa_qos_index_masked_value_set(&elt,
                   src->fields.ofdpa_qos_index);
            of_oxm_ofdpa_qos_index_masked_value_mask_set(&elt,
                   src->masks.ofdpa_qos_index);
        } else {  /* Active, but not masked */
    ...
    if (OF_MATCH_MASK_EXP_OCH_SIGID_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_EXP_OCH_SIGID_EXACT_TEST(src)) {
            of_oxm_exp_och_sigid_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_och_sigid_masked_value_set(&elt,
                   src->fields.exp_och_sigid);
            of_oxm_exp_och_sigid_masked_value_mask_set(&elt,
                   src->masks.exp_och_sigid);
        } else {  /* Active, but not masked */
            of_oxm_exp_och_sigid_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_exp_och_sigid_value_set(&elt, src->fields.exp_och_sigid);
        }
    }
    ...
    if (OF_MATCH_MASK_OFDPA_OVID_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_OFDPA_OVID_EXACT_TEST(src)) {
            of_oxm_ofdpa_ovid_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_ofdpa_ovid_masked_value_set(&elt,
                   src->fields.ofdpa_ovid);
            of_oxm_ofdpa_ovid_masked_value_mask_set(&elt,
                   src->masks.ofdpa_ovid);
        } else {  /* Active, but not masked */
    ...
    if (OF_MATCH_MASK_OFDPA_MPLS_TYPE_ACTIVE_TEST(src)) {
        if (!OF_MATCH_MASK_OFDPA_MPLS_TYPE_EXACT_TEST(src)) {
            of_oxm_ofdpa_mpls_type_masked_init(&elt,
                oxm_list->version, -1, 1);
            of_list_oxm_append_bind(oxm_list, &elt);
            of_oxm_ofdpa_mpls_type_masked_value_set(&elt,
                   src->fields.ofdpa_mpls_type);
            of_oxm_ofdpa_mpls_type_masked_value_mask_set(&elt,
                   src->masks.ofdpa_mpls_type);
        } else {  /* Active, but not masked */
...
of_match_v3_to_match(of_match_v3_t *src, of_match_t *dst)
{
    ...
    while (rv == OF_ERROR_NONE) {
        ...
        case OF_OXM_OFDPA_QOS_INDEX_MASKED:
            of_oxm_ofdpa_qos_index_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.ofdpa_qos_index);
            of_oxm_ofdpa_qos_index_masked_value_get(
                &oxm_entry,
                &dst->fields.ofdpa_qos_index);
            of_memmask(&dst->fields.ofdpa_qos_index, &dst->masks.ofdpa_qos_index, sizeof(dst->fields.ofdpa_qos_index));
            break;
        ...
        case OF_OXM_EXP_OCH_SIGTYPE_MASKED:
            of_oxm_exp_och_sigtype_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.exp_och_sigtype);
            of_oxm_exp_och_sigtype_masked_value_get(
                &oxm_entry,
                &dst->fields.exp_och_sigtype);
            of_memmask(&dst->fields.exp_och_sigtype, &dst->masks.exp_och_sigtype, sizeof(dst->fields.exp_och_sigtype));
            break;
        case OF_OXM_EXP_OCH_SIGTYPE:
            OF_MATCH_MASK_EXP_OCH_SIGTYPE_EXACT_SET(dst);
        ...
        case OF_OXM_EXP_ODU_SIGID_MASKED:
            of_oxm_exp_odu_sigid_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.exp_odu_sigid);
            of_oxm_exp_odu_sigid_masked_value_get(
                &oxm_entry,
                &dst->fields.exp_odu_sigid);
            of_memmask(&dst->fields.exp_odu_sigid, &dst->masks.exp_odu_sigid, sizeof(dst->fields.exp_odu_sigid));
            break;
        case OF_OXM_EXP_ODU_SIGID:
            OF_MATCH_MASK_EXP_ODU_SIGID_EXACT_SET(dst);
        ...
        case OF_OXM_CIRCUIT_OCH_SIGID_MASKED:
            of_oxm_circuit_och_sigid_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.circuit_och_sigid);
            of_oxm_circuit_och_sigid_masked_value_get(
                &oxm_entry,
                &dst->fields.circuit_och_sigid);
            of_memmask(&dst->fields.circuit_och_sigid, &dst->masks.circuit_och_sigid, sizeof(dst->fields.circuit_och_sigid));
            break;
        case OF_OXM_CIRCUIT_OCH_SIGID:
            OF_MATCH_MASK_CIRCUIT_OCH_SIGID_EXACT_SET(dst);
        ...
        case OF_OXM_TUN_FLAGS_MASKED:
            of_oxm_tun_flags_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.tun_flags);
            of_oxm_tun_flags_masked_value_get(
                &oxm_entry,
                &dst->fields.tun_flags);
            of_memmask(&dst->fields.tun_flags, &dst->masks.tun_flags, sizeof(dst->fields.tun_flags));
            break;
        case OF_OXM_TUN_FLAGS:
            OF_MATCH_MASK_TUN_FLAGS_EXACT_SET(dst);
        ...
        case OF_OXM_TUN_GPE_FLAGS_MASKED:
            of_oxm_tun_gpe_flags_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.tun_gpe_flags);
            of_oxm_tun_gpe_flags_masked_value_get(
                &oxm_entry,
                &dst->fields.tun_gpe_flags);
            of_memmask(&dst->fields.tun_gpe_flags, &dst->masks.tun_gpe_flags, sizeof(dst->fields.tun_gpe_flags));
            break;
        case OF_OXM_TUN_GPE_FLAGS:
            OF_MATCH_MASK_TUN_GPE_FLAGS_EXACT_SET(dst);
        ...
        case OF_OXM_TUN_GBP_ID_MASKED:
            of_oxm_tun_gbp_id_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.tun_gbp_id);
            of_oxm_tun_gbp_id_masked_value_get(
                &oxm_entry,
                &dst->fields.tun_gbp_id);
            of_memmask(&dst->fields.tun_gbp_id, &dst->masks.tun_gbp_id, sizeof(dst->fields.tun_gbp_id));
            break;
        case OF_OXM_TUN_GBP_ID:
            OF_MATCH_MASK_TUN_GBP_ID_EXACT_SET(dst);
        ...
        case OF_OXM_EXP_OCH_SIGID_MASKED:
            of_oxm_exp_och_sigid_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.exp_och_sigid);
            of_oxm_exp_och_sigid_masked_value_get(
                &oxm_entry,
                &dst->fields.exp_och_sigid);
            of_memmask(&dst->fields.exp_och_sigid, &dst->masks.exp_och_sigid, sizeof(dst->fields.exp_och_sigid));
            break;
        case OF_OXM_EXP_OCH_SIGID:
            OF_MATCH_MASK_EXP_OCH_SIGID_EXACT_SET(dst);
            of_oxm_exp_och_sigid_value_get(
                &oxm_entry,
                &dst->fields.exp_och_sigid);
            break;

        case OF_OXM_EXP_ODU_SIGTYPE_MASKED:
            of_oxm_exp_odu_sigtype_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.exp_odu_sigtype);
            of_oxm_exp_odu_sigtype_masked_value_get(
                &oxm_entry,
                &dst->fields.exp_odu_sigtype);
            of_memmask(&dst->fields.exp_odu_sigtype, &dst->masks.exp_odu_sigtype, sizeof(dst->fields.exp_odu_sigtype));
            break;
        case OF_OXM_EXP_ODU_SIGTYPE:
            OF_MATCH_MASK_EXP_ODU_SIGTYPE_EXACT_SET(dst);
        ...
        case OF_OXM_NSH_C4_MASKED:
            ...
            of_oxm_nsh_c4_masked_value_get(
                &oxm_entry,
                &dst->fields.nsh_c4);
            of_memmask(&dst->fields.nsh_c4, &dst->masks.nsh_c4, sizeof(dst->fields.nsh_c4));
            break;
        case OF_OXM_NSH_C4:
            OF_MATCH_MASK_NSH_C4_EXACT_SET(dst);
            of_oxm_nsh_c4_value_get(
                &oxm_entry,
                &dst->fields.nsh_c4);
            break;

        case OF_OXM_NSH_C1_MASKED:
            ...
            of_oxm_nsh_c1_masked_value_get(
                &oxm_entry,
                &dst->fields.nsh_c1);
            of_memmask(&dst->fields.nsh_c1, &dst->masks.nsh_c1, sizeof(dst->fields.nsh_c1));
            break;
        case OF_OXM_NSH_C1:
            OF_MATCH_MASK_NSH_C1_EXACT_SET(dst);
            of_oxm_nsh_c1_value_get(
                &oxm_entry,
                &dst->fields.nsh_c1);
            break;

        case OF_OXM_NSH_C3_MASKED:
            ...
            of_oxm_nsh_c3_masked_value_get(
                &oxm_entry,
                &dst->fields.nsh_c3);
            of_memmask(&dst->fields.nsh_c3, &dst->masks.nsh_c3, sizeof(dst->fields.nsh_c3));
            break;
        case OF_OXM_NSH_C3:
            OF_MATCH_MASK_NSH_C3_EXACT_SET(dst);
            of_oxm_nsh_c3_value_get(
                &oxm_entry,
                &dst->fields.nsh_c3);
            break;

        case OF_OXM_NSH_C2_MASKED:
            ...
            of_oxm_nsh_c2_masked_value_get(
                &oxm_entry,
                &dst->fields.nsh_c2);
            of_memmask(&dst->fields.nsh_c2, &dst->masks.nsh_c2, sizeof(dst->fields.nsh_c2));
            break;
        case OF_OXM_NSH_C2:
            OF_MATCH_MASK_NSH_C2_EXACT_SET(dst);
        ...
        case OF_OXM_OCH_SIGATT_MASKED:
            of_oxm_och_sigatt_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.och_sigatt);
            of_oxm_och_sigatt_masked_value_get(
                &oxm_entry,
                &dst->fields.och_sigatt);
            of_memmask(&dst->fields.och_sigatt, &dst->masks.och_sigatt, sizeof(dst->fields.och_sigatt));
            break;
        case OF_OXM_OCH_SIGATT:
            OF_MATCH_MASK_OCH_SIGATT_EXACT_SET(dst);
        ...
        case OF_OXM_ENCAP_ETH_DST_MASKED:
            of_oxm_encap_eth_dst_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.encap_eth_dst);
            of_oxm_encap_eth_dst_masked_value_get(
                &oxm_entry,
                &dst->fields.encap_eth_dst);
            of_memmask(&dst->fields.encap_eth_dst, &dst->masks.encap_eth_dst, sizeof(dst->fields.encap_eth_dst));
            break;
        case OF_OXM_ENCAP_ETH_DST:
            OF_MATCH_MASK_ENCAP_ETH_DST_EXACT_SET(dst);
        ...
        case OF_OXM_NSI_MASKED:
            ...
            of_oxm_nsi_masked_value_get(
                &oxm_entry,
                &dst->fields.nsi);
            of_memmask(&dst->fields.nsi, &dst->masks.nsi, sizeof(dst->fields.nsi));
            break;
        case OF_OXM_NSI:
            OF_MATCH_MASK_NSI_EXACT_SET(dst);
        ...
        case OF_OXM_NSP_MASKED:
            ...
            of_oxm_nsp_masked_value_get(
                &oxm_entry,
                &dst->fields.nsp);
            of_memmask(&dst->fields.nsp, &dst->masks.nsp, sizeof(dst->fields.nsp));
            break;
        case OF_OXM_NSP:
            OF_MATCH_MASK_NSP_EXACT_SET(dst);
        ...
        case OF_OXM_OFDPA_MPLS_L2_PORT_MASKED:
            ...
            of_memmask(&dst->fields.ofdpa_mpls_l2_port, &dst->masks.ofdpa_mpls_l2_port, sizeof(dst->fields.ofdpa_mpls_l2_port));
            break;
        ...
        case OF_OXM_ENCAP_ETH_TYPE_MASKED:
            of_oxm_encap_eth_type_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.encap_eth_type);
            of_oxm_encap_eth_type_masked_value_get(
                &oxm_entry,
                &dst->fields.encap_eth_type);
            of_memmask(&dst->fields.encap_eth_type, &dst->masks.encap_eth_type, sizeof(dst->fields.encap_eth_type));
            break;
        case OF_OXM_ENCAP_ETH_TYPE:
            OF_MATCH_MASK_ENCAP_ETH_TYPE_EXACT_SET(dst);
        ...
        case OF_OXM_CIRCUIT_OCH_SIGTYPE_BASIC_MASKED:
            of_oxm_circuit_och_sigtype_basic_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.circuit_och_sigtype_basic);
            of_oxm_circuit_och_sigtype_basic_masked_value_get(
                &oxm_entry,
                &dst->fields.circuit_och_sigtype_basic);
            of_memmask(&dst->fields.circuit_och_sigtype_basic, &dst->masks.circuit_och_sigtype_basic, sizeof(dst->fields.circuit_och_sigtype_basic));
            break;
        case OF_OXM_CIRCUIT_OCH_SIGTYPE_BASIC:
            OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_BASIC_EXACT_SET(dst);
            of_oxm_circuit_och_sigtype_basic_value_get(
                &oxm_entry,
                &dst->fields.circuit_och_sigtype_basic);
            break;

        case OF_OXM_OCH_SIGATT_BASIC_MASKED:
            of_oxm_och_sigatt_basic_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.och_sigatt_basic);
            of_oxm_och_sigatt_basic_masked_value_get(
                &oxm_entry,
                &dst->fields.och_sigatt_basic);
            of_memmask(&dst->fields.och_sigatt_basic, &dst->masks.och_sigatt_basic, sizeof(dst->fields.och_sigatt_basic));
            break;
        case OF_OXM_OCH_SIGATT_BASIC:
            OF_MATCH_MASK_OCH_SIGATT_BASIC_EXACT_SET(dst);
        ...
        case OF_OXM_CIRCUIT_OCH_SIGTYPE_MASKED:
            of_oxm_circuit_och_sigtype_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.circuit_och_sigtype);
            of_oxm_circuit_och_sigtype_masked_value_get(
                &oxm_entry,
                &dst->fields.circuit_och_sigtype);
            of_memmask(&dst->fields.circuit_och_sigtype, &dst->masks.circuit_och_sigtype, sizeof(dst->fields.circuit_och_sigtype));
            break;
        case OF_OXM_CIRCUIT_OCH_SIGTYPE:
            OF_MATCH_MASK_CIRCUIT_OCH_SIGTYPE_EXACT_SET(dst);
        ...
        case OF_OXM_OFDPA_OVID_MASKED:
            of_oxm_ofdpa_ovid_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.ofdpa_ovid);
            of_oxm_ofdpa_ovid_masked_value_get(
                &oxm_entry,
                &dst->fields.ofdpa_ovid);
            of_memmask(&dst->fields.ofdpa_ovid, &dst->masks.ofdpa_ovid, sizeof(dst->fields.ofdpa_ovid));
            break;
        ...
        case OF_OXM_TUN_GPE_NP_MASKED:
            of_oxm_tun_gpe_np_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.tun_gpe_np);
            of_oxm_tun_gpe_np_masked_value_get(
                &oxm_entry,
                &dst->fields.tun_gpe_np);
            of_memmask(&dst->fields.tun_gpe_np, &dst->masks.tun_gpe_np, sizeof(dst->fields.tun_gpe_np));
            break;
        case OF_OXM_TUN_GPE_NP:
            OF_MATCH_MASK_TUN_GPE_NP_EXACT_SET(dst);
        ...
        case OF_OXM_ENCAP_ETH_SRC_MASKED:
            of_oxm_encap_eth_src_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.encap_eth_src);
            of_oxm_encap_eth_src_masked_value_get(
                &oxm_entry,
                &dst->fields.encap_eth_src);
            of_memmask(&dst->fields.encap_eth_src, &dst->masks.encap_eth_src, sizeof(dst->fields.encap_eth_src));
            break;
        case OF_OXM_ENCAP_ETH_SRC:
            OF_MATCH_MASK_ENCAP_ETH_SRC_EXACT_SET(dst);
            of_oxm_encap_eth_src_value_get(
                &oxm_entry,
                &dst->fields.encap_eth_src);
            break;

        case OF_OXM_CIRCUIT_OCH_SIGID_BASIC_MASKED:
            of_oxm_circuit_och_sigid_basic_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.circuit_och_sigid_basic);
            of_oxm_circuit_och_sigid_basic_masked_value_get(
                &oxm_entry,
                &dst->fields.circuit_och_sigid_basic);
            of_memmask(&dst->fields.circuit_och_sigid_basic, &dst->masks.circuit_och_sigid_basic, sizeof(dst->fields.circuit_och_sigid_basic));
            break;
        case OF_OXM_CIRCUIT_OCH_SIGID_BASIC:
            OF_MATCH_MASK_CIRCUIT_OCH_SIGID_BASIC_EXACT_SET(dst);
        ...
        case OF_OXM_NSH_MDTYPE_MASKED:
            of_oxm_nsh_mdtype_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.nsh_mdtype);
            of_oxm_nsh_mdtype_masked_value_get(
                &oxm_entry,
                &dst->fields.nsh_mdtype);
            of_memmask(&dst->fields.nsh_mdtype, &dst->masks.nsh_mdtype, sizeof(dst->fields.nsh_mdtype));
            break;
        case OF_OXM_NSH_MDTYPE:
            OF_MATCH_MASK_NSH_MDTYPE_EXACT_SET(dst);
        ...
        case OF_OXM_TUN_GBP_FLAGS_MASKED:
            of_oxm_tun_gbp_flags_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.tun_gbp_flags);
            of_oxm_tun_gbp_flags_masked_value_get(
                &oxm_entry,
                &dst->fields.tun_gbp_flags);
            of_memmask(&dst->fields.tun_gbp_flags, &dst->masks.tun_gbp_flags, sizeof(dst->fields.tun_gbp_flags));
            break;
        case OF_OXM_TUN_GBP_FLAGS:
            OF_MATCH_MASK_TUN_GBP_FLAGS_EXACT_SET(dst);
        ...
        case OF_OXM_OFDPA_MPLS_TYPE_MASKED:
            of_oxm_ofdpa_mpls_type_masked_value_mask_get(
                &oxm_entry,
                &dst->masks.ofdpa_mpls_type);
            of_oxm_ofdpa_mpls_type_masked_value_get(
                &oxm_entry,
                &dst->fields.ofdpa_mpls_type);
            of_memmask(&dst->fields.ofdpa_mpls_type, &dst->masks.ofdpa_mpls_type, sizeof(dst->fields.ofdpa_mpls_type));
            break;
        ...
        case OF_OXM_NSH_NP_MASKED:
            ...
            of_oxm_nsh_np_masked_value_get(
                &oxm_entry,
                &dst->fields.nsh_np);
            of_memmask(&dst->fields.nsh_np, &dst->masks.nsh_np, sizeof(dst->fields.nsh_np));
            break;
        case OF_OXM_NSH_NP:
            OF_MATCH_MASK_NSH_NP_EXACT_SET(dst);
