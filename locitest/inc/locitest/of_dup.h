...
extern of_object_t *
    of_calient_flow_stats_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_flow_stats_request_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_stats_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_stats_request_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_stats_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_stats_request_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_status_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_stats_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_stats_request_dup(
        of_object_t *src);

extern of_object_t *
    of_circuit_port_status_dup(
        of_object_t *src);

extern of_object_t *
    of_circuit_ports_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_circuit_ports_request_dup(
        of_object_t *src);
...
extern of_object_t *
    of_exp_optical_ext_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_optical_ext_request_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_adjacency_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_adjacency_request_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_desc_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_desc_request_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oplink_channel_power_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_channel_power_request_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_exp_header_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_request_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_set_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_stats_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_stats_request_dup(
        of_object_t *src);
...
extern of_object_t *
    of_sdwn_add_client_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_add_lvap_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_del_client_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_del_lvap_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_channel_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_channel_request_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_crypto_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_lvap_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_normal_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_request_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_remote_port_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_remote_port_request_dup(
        of_object_t *src);
...
extern of_object_t *
    of_sdwn_ieee80211_mgmt_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_ieee80211_mgmt_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_mod_lvap_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_packet_in_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_port_desc_reply_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_port_desc_request_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_nicira_move_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_nicira_pop_nsh_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_nicira_push_nsh_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_ofdpa_pop_l2_header_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_ofdpa_push_l2_header_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_oplink_att_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_nicira_move_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_pop_nsh_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_push_nsh_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_ofdpa_pop_l2_header_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_ofdpa_push_l2_header_dup(
        of_object_t *src);

extern of_object_t *
    of_action_oplink_att_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_icmp_code_dup(
        of_object_t *src);

extern of_object_t *
    of_bsn_tlv_icmp_id_dup(
        of_object_t *src);

extern of_object_t *
    of_bsn_tlv_icmp_type_dup(
        of_object_t *src);
...
extern of_object_t *
    of_calient_flow_stats_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_prop_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_prop_optical_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_stats_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_stats_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_ext_ad_id_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_ext_ad_id_port_otn_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_ext_ad_id_sonet_dup(
        of_object_t *src);
...
extern of_object_t *
    of_exp_port_adjacency_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_adjacency_id_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_des_prop_header_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_desc_prop_optical_transport_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_optical_transport_feature_header_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_optical_transport_layer_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_optical_transport_layer_stack_dup(
        of_object_t *src);
...
extern of_object_t *
    of_ieee80211_ht_cap_dup(
        of_object_t *src);

extern of_object_t *
    of_ieee80211_mcs_info_dup(
        of_object_t *src);

extern of_object_t *
    of_ieee80211_vht_cap_dup(
        of_object_t *src);

extern of_object_t *
    of_ieee80211_vht_mcs_info_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oplink_channel_power_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_bsn_l2_cache_hit_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_circuit_och_sigid_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigid_basic_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigid_basic_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigid_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_basic_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_basic_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_dst_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_dst_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_exp_och_sigid_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_och_sigid_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_och_sigtype_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_och_sigtype_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigid_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigid_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigtype_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigtype_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_nsh_c4_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_nsp_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_basic_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_basic_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_ofdpa_mpls_type_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_ofdpa_mpls_type_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_ofdpa_qos_index_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_tun_flags_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_flags_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_masked_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_masked_dup(
        of_object_t *src);
...
extern of_object_t *
    of_port_desc_prop_optical_transport_dup(
        of_object_t *src);
...
extern of_object_t *
    of_port_optical_transport_application_code_dup(
        of_object_t *src);

extern of_object_t *
    of_port_optical_transport_layer_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_port_optical_transport_layer_stack_dup(
        of_object_t *src);
...
extern of_object_t *
    of_sdwn_entity_accesspoint_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_band_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_freq_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_nic_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_rate_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_related_switch_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_calient_flow_stats_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_list_calient_port_desc_prop_dup(
        of_object_t *src);

extern of_object_t *
    of_list_calient_port_desc_stats_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_list_calient_port_stats_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_ext_ad_id_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_adjacency_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_adjacency_id_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_desc_prop_optical_transport_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_optical_transport_layer_entry_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_optical_transport_layer_stack_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_oplink_channel_power_dup(
        of_object_t *src);

extern of_object_t *
    of_list_oplink_port_power_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_port_desc_prop_optical_transport_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_port_optical_dup(
        of_object_t *src);

extern of_object_t *
    of_list_port_optical_transport_layer_entry_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_nicira_move_OF_VERSION_1_0_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_pop_nsh_OF_VERSION_1_0_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_push_nsh_OF_VERSION_1_0_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_nicira_move_OF_VERSION_1_1_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_pop_nsh_OF_VERSION_1_1_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_push_nsh_OF_VERSION_1_1_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_nicira_move_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_pop_nsh_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_push_nsh_OF_VERSION_1_2_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_bsn_l2_cache_hit_masked_OF_VERSION_1_2_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_encap_eth_dst_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_dst_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_masked_OF_VERSION_1_2_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_nsh_c1_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c1_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c2_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c2_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c3_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c3_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c4_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c4_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_np_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_np_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsi_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsi_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsp_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsp_masked_OF_VERSION_1_2_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_tun_flags_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_flags_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_masked_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_OF_VERSION_1_2_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_masked_OF_VERSION_1_2_dup(
        of_object_t *src);
...
extern of_object_t *
    of_calient_flow_stats_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_flow_stats_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_stats_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_stats_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_stats_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_stats_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_status_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_circuit_port_status_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_circuit_ports_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_circuit_ports_request_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_exp_port_adjacency_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_adjacency_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_desc_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_desc_request_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oplink_channel_power_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_channel_power_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_set_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_sdwn_add_client_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_add_lvap_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_del_client_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_del_lvap_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_channel_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_channel_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_crypto_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_lvap_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_reply_normal_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_clients_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_remote_port_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_get_remote_port_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_ieee80211_mgmt_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_ieee80211_mgmt_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_mod_lvap_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_packet_in_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_port_desc_reply_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_port_desc_request_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_set_channel_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_circuit_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_circuit_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_nicira_move_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_nicira_pop_nsh_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_nicira_push_nsh_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_ofdpa_pop_l2_header_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_ofdpa_push_l2_header_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_oplink_att_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_nicira_move_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_pop_nsh_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_push_nsh_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_ofdpa_pop_l2_header_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_ofdpa_push_l2_header_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_action_oplink_att_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_anchor_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_data_mask_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_icmp_code_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_bsn_tlv_icmp_id_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_bsn_tlv_icmp_type_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_ip_proto_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_ipv6_prefix_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_status_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_calient_flow_stats_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_prop_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_prop_optical_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_desc_stats_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_calient_port_stats_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_ext_ad_id_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_ext_ad_id_port_otn_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_ext_ad_id_sonet_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_adjacency_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_adjacency_id_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_des_prop_header_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_desc_prop_optical_transport_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_optical_transport_feature_header_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_optical_transport_layer_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_exp_port_optical_transport_layer_stack_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_ieee80211_ht_cap_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_ieee80211_mcs_info_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_ieee80211_vht_cap_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_ieee80211_vht_mcs_info_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oplink_channel_power_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oplink_port_power_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_bsn_l2_cache_hit_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_circuit_och_sigid_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigid_basic_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigid_basic_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigid_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_basic_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_basic_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_circuit_och_sigtype_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_dst_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_dst_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_exp_och_sigid_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_och_sigid_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_och_sigtype_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_och_sigtype_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigid_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigid_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigtype_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_exp_odu_sigtype_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_nsh_c1_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c1_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c2_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c2_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c3_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c3_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c4_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c4_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_np_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_np_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsi_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsi_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsp_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsp_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_basic_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_basic_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_och_sigatt_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_ofdpa_mpls_type_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_ofdpa_mpls_type_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_ofdpa_ovid_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_ofdpa_qos_index_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_tun_flags_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_flags_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_masked_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_masked_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_port_desc_prop_optical_transport_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_port_optical_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_port_optical_transport_application_code_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_port_optical_transport_layer_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_port_optical_transport_layer_stack_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_sdwn_entity_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_accesspoint_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_band_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_freq_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_nic_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_rate_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_sdwn_entity_related_switch_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_bsn_tlv_data_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_calient_flow_stats_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_calient_port_desc_prop_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_calient_port_desc_stats_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_calient_port_stats_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_ext_ad_id_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_adjacency_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_adjacency_id_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_desc_prop_optical_transport_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_optical_transport_layer_entry_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_exp_port_optical_transport_layer_stack_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_oplink_channel_power_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_oplink_port_power_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_port_desc_prop_optical_transport_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_port_optical_OF_VERSION_1_3_dup(
        of_object_t *src);

extern of_object_t *
    of_list_port_optical_transport_layer_entry_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_list_sdwn_entity_OF_VERSION_1_3_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_id_nicira_move_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_nicira_pop_nsh_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_action_id_nicira_push_nsh_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_action_nicira_move_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_pop_nsh_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_action_nicira_push_nsh_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_data_mask_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_icmp_code_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_bsn_tlv_icmp_id_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_bsn_tlv_icmp_type_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_ip_proto_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_ipv6_prefix_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_bsn_tlv_status_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_instruction_bsn_auto_negotiation_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_instruction_id_bsn_auto_negotiation_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_encap_eth_dst_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_dst_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_src_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_encap_eth_type_masked_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_nsh_c1_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c1_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c2_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c2_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c3_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c3_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c4_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_c4_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_mdtype_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_np_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsh_np_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsi_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsi_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsp_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_nsp_masked_OF_VERSION_1_4_dup(
        of_object_t *src);
...
extern of_object_t *
    of_oxm_tun_flags_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_flags_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_flags_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gbp_id_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_flags_masked_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_OF_VERSION_1_4_dup(
        of_object_t *src);

extern of_object_t *
    of_oxm_tun_gpe_np_masked_OF_VERSION_1_4_dup(
        of_object_t *src);
